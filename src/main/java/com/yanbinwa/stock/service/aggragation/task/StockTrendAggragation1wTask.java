...
public class StockTrendAggragation1wTask extends AbstractAggragation
{
    private static Logger logger = Logger.getLogger(StockTrendAggragation1wTask.class);
...
//    private static final HourWindow[] hourWindowArray = {HourWindow.HOUR9, HourWindow.HOUR10, HourWindow.HOUR13, HourWindow.HOUR14};
    ...
    private static final int periodInterval = Period.SECOND_IN_DAY * 7;
    
    public StockTrendAggragation1wTask(String taskName)
    {
        super(taskName);
    }
    ...
    public void aggragationLogic()
    {
        ...
        StockTrendUtils.stockTrendAggragationLogic(StockTrendType.TYPE_1D, StockTrendType.TYPE_1W, periodInterval, false, StockTrendAgg1w.class);
    }
